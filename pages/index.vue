...
// Video demo bắt buộc autoplay ở trạng thái muted (trình duyệt chặn autoplay có
// tiếng) — thêm nút loa để ai muốn nghe có thể tự bật, âm lượng giữ mức bình
// thường (không ép nhỏ) khi bật.
const heroVideoRef = ref<HTMLVideoElement | null>(null);
const heroVideoMuted = ref(true);
const toggleHeroVideoSound = () => {
  heroVideoMuted.value = !heroVideoMuted.value;
  if (heroVideoRef.value) heroVideoRef.value.muted = heroVideoMuted.value;
};
...
<template>
  ...
  <div class="hero-banner">
    ...
    <div class="hero-inner">
      ...
      <!-- Right visual — demo video AI thật, tự chạy/lặp lại. Autoplay bắt buộc phải
      muted (trình duyệt chặn autoplay có tiếng), nên thêm nút loa để ai muốn nghe tự bật. -->
      <div class="hero-visual">
        <div class="hv-card">
          <div class="hv-screen">
            ...
            <button
              type="button"
              class="hv-sound-toggle"
              :aria-label="heroVideoMuted ? 'Bật tiếng' : 'Tắt tiếng'"
